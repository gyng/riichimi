...
`fixtures/guided-hand.png` is a transformed test fixture derived from Cangjie6's [`Mahjong eg JP Kantou.jpg`](https://commons.wikimedia.org/wiki/File:Mahjong_eg_JP_Kantou.jpg), licensed [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). It is generated by `scripts/vision/build-guided-e2e-fixture.py` from the evaluation partition and is never used for training.
