...
Checkpoint 14 uses the reproducible blurred derivative of that fixture to prove the scanner distinguishes image sharpness from tile-layout failure and keeps visible recovery paths available.
